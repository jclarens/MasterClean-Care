...
public class RecyclerAdapterPenawaranAccepted extends RecyclerView.Adapter<RecyclerAdapterPenawaranAccepted.ViewHolder> {
    ...
    @Override
    public RecyclerAdapterPenawaranAccepted.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_offer, parent, false);
        RecyclerAdapterPenawaranAccepted.ViewHolder viewHolder = new RecyclerAdapterPenawaranAccepted.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerAdapterPenawaranAccepted.ViewHolder holder, int position) {
